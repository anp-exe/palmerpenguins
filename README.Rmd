...
Project notebook: [`my-work-penguins.ipynb`](my-work-penguins.ipynb) shows a short end-to-end analysis that loads the penguins data, cleans missing values, runs KMeans clustering, and visualizes the cluster results.
